...
app.use('/api/projects/:projectId/invoices', invoiceRoutes);         // חשבוניות תחת פרויקט
app.use('/api/projects/:projectId/orders', orderRoutes);             // הזמנות תחת פרויקט
app.use('/api/projects/:projectId/suppliers', suppliersRoutes);      // ספקים תחת פרויקט
