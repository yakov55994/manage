  ...
  if (loadingProject || loadingInvoices || loadingOrders) {
    return (
      <div className="flex flex-col justify-center items-center h-64">
        <ClipLoader size={100} color="#3498db" loading={loadingProject || loadingInvoices || loadingOrders} />
...
const formatCurrencyWithAlert = (num) => {
  ...
  return (
    <div className="container mx-auto p-6">
          ...
          <div className="grid grid-cols-5 gap-4 text-lg text-black">
           ...
           <div className=" border-gray-500 pl-4">
            ...
            <div className="border-l-2 border-gray-500 pl-4">
              ...
              <span className="text-l">{project.budget ? formatCurrencyWithAlert(project.budget) : "עדיין אין תקציב"}</span>
            </div>
      ...
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-slate-800 mb-7 text-center"> הזמנות של הפרוייקט</h2>
              ...
              {loadingOrders ? (
                ...
                filteredOrders.map((order) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 font-bold">{formatCurrencyWithAlert(order.sum)}</td>
                ...
                <tr>
                  <td colSpan="7" className="text-center">
                    <p className="font-bold text-2xl text-red-500 mt-2 mb-2">לא נמצאו הזמנות . . .</p>
                  </td>
                </tr>
              )}
            </tbody>
      ...
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-slate-800 mb-4 text-center">חשבוניות של הפרוייקט</h2>
        <div className="overflow-x-auto rounded-lg border border-slate-200">
          <table className="w-full">
            <thead>
              <tr className="bg-slate-300 text-slate-800 text-l">
            ...
            <tbody>
              {loadingInvoices ? (
                <tr>
                  <td colSpan="7" className="text-center">
                    <p className="font-bold text-xl text-cyan-500">טוען . . .</p>
                  </td>
                </tr>
                ...
                filteredInvoices.map((invoice) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 font-bold">{formatCurrencyWithAlert(invoice.sum)}</td>
                ...
                <tr>
                  <td colSpan="7" className="text-center ">
                    <p className="font-bold text-2xl text-red-500 mt-2 mb-2">לא נמצאו חשבוניות . . .</p>
                  </td>
                </tr>
              )}
            </tbody>
